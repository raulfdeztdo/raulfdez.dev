...
export const ui = {
    es: {
        ...
        'hero.description': '<b>+4 años de experiencia</b>. Andaluz viviendo en Galicia. Desarrollo de software. Especializado en el desarrollo de aplicaciones web con PHP (Symfony y Laravel)',
        ...
        'experience.emais.description': 'Desarrollo y mantenimiento de aplicación (Tailor) en el equipo de back-end para la gestión de activos inmobiliarios.',
        ...
        'experience.sunaca.date': 'Sep 2022 - May 2023',
        ...
        'projects.exhibify.description': 'Plataforma de venta de obras de arte, publicación de exhibiciones gestionadas por galerías y ferias de arte. Creada con Shopify y personalizada para ITGallery mediante template de Liquid',
        ...
        'meta.description': 'Desarrollador de software con mças de 4 años de experiencia. Especializado en aplicaciones web con PHP (Laracel y Symfony) y scripting con Python',
    },
    en: {
        'nav.home': 'Home',
        ...
        'hero.description': '<b>+4 years of experience</b>. Andalusian living in Galicia. Software development. Specialized in web application development with PHP (Symfony and Laravel)',
        'hero.contact': 'Contact me',

        'section.experience': 'Work Experience',
        'section.projects': 'Participated Projects',
        'section.about': 'About me',

        'experience.emais.date': 'May 2024 - Currently',
        'experience.emais.title': 'Back-end Developer',
        'experience.emais.company': '<a href="https://www.emais.es" target="_blank">Emais</a>',
        'experience.emais.description': 'Development and maintenance of application (Tailor) in the back-end team for real estate asset management.',

        'experience.itgallery.date': 'Aug 2022 - May 2024',
        'experience.itgallery.title': 'Fullstack Developer',
        'experience.itgallery.company': '<a href="https://www.itgalleryapp.com/" target="_blank">IT Gallery SLU</a>',
        'experience.itgallery.description': 'Development of new improvements and fixes for the <b><a href="https://www.itgalleryapp.com/es/base-datos.html" target="_blank">ITGallery</a></b> web application developed through a Laravel API. Development of the <b><a href="https://exhibify.net/" target="_blank">Exhibify</a></b> web application developed in a Shopify Liquid template.',
        ...
        'projects.exhibify.title': 'Exhibify',
        'projects.exhibify.description': 'Artwork sales platform, publication of exhibitions managed by galleries and art fairs. Created with Shopify and customized for ITGallery through Liquid template',
        ...
        'about.paragraph2_continuation': '. with the specialty of "Information Technologies"',
        'about.paragraph3': 'As a software developer',
        'about.paragraph3_highlight': 'I have always worked with PHP, although I have knowledge in ',
        'about.paragraph3_emphasis': 'C++, Java, Python as back-end programming languages and basic knowledge in Javascript ',
        'about.paragraph3_continuation': 'and some of its frameworks like Vue.js and React',
        'about.paragraph3_end': '. In my free time, apart from doing sports, I like to learn trading and create indicators with Pine Script, as well as research and understand how new advances with AI work.',
